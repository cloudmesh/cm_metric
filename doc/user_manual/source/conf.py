...
# sphinx-quickstart on Thu Mar  7 11:29:19 2013.
#
...
copyright = u'2014, Developed for CloudMesh (previously FutureGrid) by Gregor von Laszewski, Hyungro Lee, Fugang Wang'
...
# of the sidebar.
html_logo = "cm-logo-white-24x36.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "cm-favicon.ico"
