...
copyright = u'2014, Gregor von Laszewski, Fugang Wang, Hyungro Lee, Javier Diaz'
...
#html_theme = 'default'
# bootstrap theme will be used soon. We have applied bootstrap theme to user
# manual and other pages. - 07/01/2013 Hyungro.
