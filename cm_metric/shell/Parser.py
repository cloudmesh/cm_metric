...
NAME - cm-euca-log-parser

DESCRIPTION

usage

<TBD>   cat filename.log | cm-euca-log-parser <parameters>
...
class Instances:
    ...
    def __init__(self):
        ...
        self.data = {}
        self.eucadb = EucaMetricsDB("cloudmesh.cfg")
        self.withSQL = False
...
def main():
    ...
    parser.add_argument("-i", dest="input_dir", required=True,
                        help="Absolute path where the files (e.g. 2012-02-16-00-21-17-cc.log generated by cm-unix) exist")
    ...
    -------------------------------------
    1) cm-parser.py -s start date -e end date; will parse logs between the period that specified by -s and -e options
       ex) cm-parser.py -s 20120216 -e 20120216
           => 2012-02-16-00-21-17-cc.log ~ 2012-02-16-23-47-16-cc.log will be parsed
    2) cm-parser.py -f filename; Only parse the file that specified by -f option
       ex) cm-parser.py -f 2012-02-16-00-21-17-cc.log
